...
describe('CashFlowController (Unit)', () => {
  let req, res;
  ...
  //   CashFlowService.getData.mockResolvedValue({ some: 'data' });
  //   await CashFlowController.get(req, res);
  //   expect(res.status).toHaveBeenCalledWith(200);
  //   expect(res.json).toHaveBeenCalledWith({ some: 'data' });
  // });
  
  // it('should return 500 on error', async () => {
  //   CashFlowService.getData.mockRejectedValue(new Error('Internal error'));
  //   await CashFlowController.get(req, res);
